...
#define AC_LIFE_TASK_TIMER_LED_LIFE_INTERVAL (1000)
	...
	enum
	{
		AC_LOG_PRINT = AK_USER_DEFINE_SIG,
		AC_LOG_PUT,
		AC_LOG_PUT_EEPROM,
		AC_LOG_PRINT_EEPROM,
		AC_CLEAR_LOG_EEPROM
...
#define AC_DISPLAY_STARTUP_INTERVAL (2000)
	...
	enum
	{
		...
		AC_DISPLAY_BUTON_MODE_PRESS,
		AC_DISPLAY_BUTON_UP_RELEASED,
		AC_DISPLAY_BUTON_UP_PRESS,
		AC_DISPLAY_BUTON_UP_LONG_RELEASED,
		AC_DISPLAY_BUTON_DOWN_LONG_RELEASED,
		AC_DISPLAY_BUTON_DOWN_PRESS,
		AC_DISPLAY_BUTON_MODE_LONG_RELEASED,
		AC_DISPLAY_BUTON_DOWN_RELEASED,
		AC_DISPLAY_SHOW_LOGO,
		AC_DISPLAY_BLINK_UPDATE,
		AC_DISPLAY_UPDATE,
		AC_DISPLAY_IDLE_UPDATE,
